...
import BinhDanHocVuSidebar from "@/components/BinhDanHocVuSidebar";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_460px] gap-4 items-start">
            <div>
              <section className="border border-slate-200 bg-white p-6">
                ...
                {introContent && <p className="mt-3 text-lg text-slate-700 leading-relaxed">{introContent}</p>}
                  ...
                  <article className="mt-4 overflow-hidden border border-slate-200 bg-white">
                    ...
                    <div className="p-5">
                      ...
                      <p className="mt-3 text-base leading-relaxed text-slate-700">
                        {selectedBinhDanPost.summary || "Nội dung chi tiết đang được cập nhật."}
                      </p>
                    </div>
                  </article>
                )}
